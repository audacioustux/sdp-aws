...
export class ApplicationSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationSet {
        return new ApplicationSet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:argoproj.io/v1alpha1:ApplicationSet';
    ...
    public readonly kind!: pulumi.Output<"ApplicationSet" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta>;
    public readonly spec!: pulumi.Output<outputs.argoproj.v1alpha1.ApplicationSetSpec>;
    public readonly status!: pulumi.Output<outputs.argoproj.v1alpha1.ApplicationSetStatus | undefined>;
